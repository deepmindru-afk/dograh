...
async function WorkflowList() {
    ...
    try {
        ...
        return (
            <>
                ...
                <div className="mb-8">
                    ...
                    {activeWorkflows.length > 0 ? (
                        ...
                        <div className="text-muted-foreground bg-muted rounded-lg p-8 text-center">
                            Активные сценарии не найдены. Создайте свой первый сценарий.
                        </div>
                    )}
                </div>
                ...
                {archivedWorkflows.length > 0 && (
                    <div className="mb-8">
                        <h2 className="text-xl font-semibold mb-4 text-muted-foreground">Архивированные сценарии</h2>
        ...
        return (
            <div className="text-red-500">
                Не удалось загрузить сценарии. Пожалуйста, попробуйте позже.
            </div>
        );
    }
}
