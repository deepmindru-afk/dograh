            ...
            <div>
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-muted-foreground">Просмотр всех запусков агентов по всем голосовым агентам. Используйте фильтры для поиска.</p>
                    </div>
                ...
                <Card className="mb-6">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Отслеживание использования моделей через сервисные ключи.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoadingCredits ? (
                            ...
                            <p className="text-muted-foreground">Сервисные ключи не настроены. Настройте сервисный ключ в конфигурации моделей.</p>
                        )}
                    </CardContent>
                </Card>
                    ...
                    <CardHeader>
                        <div className="flex justify-between items-start">
                            <div className="space-y-1.5">
                                ...
                                <CardDescription>
                                    Все запуски агентов в организации с деталями использования
                                </CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                                                    ...
                                                    <TableCell>
                                                        {run.call_type ? (
                                                            <Badge variant={run.call_type === 'inbound' ? "secondary" : "default"}>
                                                                {run.call_type === 'inbound' ? 'Входящий' : 'Исходящий'}
                                                            </Badge>
                                                        ) : (
                                ...
                                {appliedFilters.length > 0 && (
                                    <div className="mt-4 p-3 bg-muted rounded-md">
                                        <p className="text-sm text-muted-foreground">
                                            Всего за выбранный период: <span className="font-semibold text-foreground">
