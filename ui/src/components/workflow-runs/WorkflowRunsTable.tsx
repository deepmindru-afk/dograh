                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle>Запуски сценария</CardTitle>
                                <CardDescription>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-muted/50">
                                        ...
                                        <TableHead className="font-semibold">Начато</TableHead>
                                        <TableHead className="font-semibold">Тип вызова</TableHead>
                                        <TableHead
                                        ...
                                        <TableHead className="font-semibold">Диспозиция</TableHead>
